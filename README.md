...
<p>
 24. I attempt to log into Client-1 using one of the accounts created earlier. It allows me to test the login credentials and verify that the account is working correctly.
</p>
<br />
...
After entering the new password, I click on the "OK" button to reset the password for the user account.
</p>
<br />
